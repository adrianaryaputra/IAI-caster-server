        ...
        for (const key in state) {
            switch(key) {
                case "AI":
                    ...
                    this.millMotorBtmS.setValue(state[key][2]);
                    this.millMotorBtmC.setValue(state[key][3]);
                    this.coilerMotorS.setValue(state[key][4]);
                    this.coilerMotorC.setValue(state[key][5]);
                    break;
